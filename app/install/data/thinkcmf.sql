...
(121, 0, 0, 1, 30, 'iqsa', 'AdminIndex', 'default', '', '门户管理', 'th', '门户管理'),
(122, 121, 1, 1, 10000, 'iqsa', 'AdminArticle', 'index', '', '文章管理', '', '文章列表'),
(123, 122, 1, 0, 10000, 'iqsa', 'AdminArticle', 'add', '', '添加文章', '', '添加文章'),
(124, 122, 2, 0, 10000, 'iqsa', 'AdminArticle', 'addPost', '', '添加文章提交', '', '添加文章提交'),
(125, 122, 1, 0, 10000, 'iqsa', 'AdminArticle', 'edit', '', '编辑文章', '', '编辑文章'),
(126, 122, 2, 0, 10000, 'iqsa', 'AdminArticle', 'editPost', '', '编辑文章提交', '', '编辑文章提交'),
(127, 122, 2, 0, 10000, 'iqsa', 'AdminArticle', 'delete', '', '文章删除', '', '文章删除'),
(128, 122, 2, 0, 10000, 'iqsa', 'AdminArticle', 'publish', '', '文章发布', '', '文章发布'),
(129, 122, 2, 0, 10000, 'iqsa', 'AdminArticle', 'top', '', '文章置顶', '', '文章置顶'),
(130, 122, 2, 0, 10000, 'iqsa', 'AdminArticle', 'recommend', '', '文章推荐', '', '文章推荐'),
(131, 122, 2, 0, 10000, 'iqsa', 'AdminArticle', 'listOrder', '', '文章排序', '', '文章排序'),
(132, 121, 1, 1, 10000, 'iqsa', 'AdminCategory', 'index', '', '分类管理', '', '文章分类列表'),
(133, 132, 1, 0, 10000, 'iqsa', 'AdminCategory', 'add', '', '添加文章分类', '', '添加文章分类'),
(134, 132, 2, 0, 10000, 'iqsa', 'AdminCategory', 'addPost', '', '添加文章分类提交', '', '添加文章分类提交'),
(135, 132, 1, 0, 10000, 'iqsa', 'AdminCategory', 'edit', '', '编辑文章分类', '', '编辑文章分类'),
(136, 132, 2, 0, 10000, 'iqsa', 'AdminCategory', 'editPost', '', '编辑文章分类提交', '', '编辑文章分类提交'),
(137, 132, 1, 0, 10000, 'iqsa', 'AdminCategory', 'select', '', '文章分类选择对话框', '', '文章分类选择对话框'),
(138, 132, 2, 0, 10000, 'iqsa', 'AdminCategory', 'listOrder', '', '文章分类排序', '', '文章分类排序'),
(139, 132, 2, 0, 10000, 'iqsa', 'AdminCategory', 'delete', '', '删除文章分类', '', '删除文章分类'),
(140, 121, 1, 1, 10000, 'iqsa', 'AdminPage', 'index', '', '页面管理', '', '页面管理'),
(141, 140, 1, 0, 10000, 'iqsa', 'AdminPage', 'add', '', '添加页面', '', '添加页面'),
(142, 140, 2, 0, 10000, 'iqsa', 'AdminPage', 'addPost', '', '添加页面提交', '', '添加页面提交'),
(143, 140, 1, 0, 10000, 'iqsa', 'AdminPage', 'edit', '', '编辑页面', '', '编辑页面'),
(144, 140, 2, 0, 10000, 'iqsa', 'AdminPage', 'editPost', '', '编辑页面提交', '', '编辑页面提交'),
(145, 140, 2, 0, 10000, 'iqsa', 'AdminPage', 'delete', '', '删除页面', '', '删除页面'),
(146, 121, 1, 1, 10000, 'iqsa', 'AdminTag', 'index', '', '文章标签', '', '文章标签'),
(147, 146, 1, 0, 10000, 'iqsa', 'AdminTag', 'add', '', '添加文章标签', '', '添加文章标签'),
(148, 146, 2, 0, 10000, 'iqsa', 'AdminTag', 'addPost', '', '添加文章标签提交', '', '添加文章标签提交'),
(149, 146, 2, 0, 10000, 'iqsa', 'AdminTag', 'upStatus', '', '更新标签状态', '', '更新标签状态'),
(150, 146, 2, 0, 10000, 'iqsa', 'AdminTag', 'delete', '', '删除文章标签', '', '删除文章标签'),
...
(120, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/index', '', '文章管理', ''),
(121, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/add', '', '添加文章', ''),
(122, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/addPost', '', '添加文章提交', ''),
(123, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/edit', '', '编辑文章', ''),
(124, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/editPost', '', '编辑文章提交', ''),
(125, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/delete', '', '文章删除', ''),
(126, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/publish', '', '文章发布', ''),
(127, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/top', '', '文章置顶', ''),
(128, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/recommend', '', '文章推荐', ''),
(129, 1, 'iqsa', 'admin_url', 'iqsa/AdminArticle/listOrder', '', '文章排序', ''),
(130, 1, 'iqsa', 'admin_url', 'iqsa/AdminCategory/index', '', '分类管理', ''),
(131, 1, 'iqsa', 'admin_url', 'iqsa/AdminCategory/add', '', '添加文章分类', ''),
(132, 1, 'iqsa', 'admin_url', 'iqsa/AdminCategory/addPost', '', '添加文章分类提交', ''),
(133, 1, 'iqsa', 'admin_url', 'iqsa/AdminCategory/edit', '', '编辑文章分类', ''),
(134, 1, 'iqsa', 'admin_url', 'iqsa/AdminCategory/editPost', '', '编辑文章分类提交', ''),
(135, 1, 'iqsa', 'admin_url', 'iqsa/AdminCategory/select', '', '文章分类选择对话框', ''),
(136, 1, 'iqsa', 'admin_url', 'iqsa/AdminCategory/listOrder', '', '文章分类排序', ''),
(137, 1, 'iqsa', 'admin_url', 'iqsa/AdminCategory/delete', '', '删除文章分类', ''),
(138, 1, 'iqsa', 'admin_url', 'iqsa/AdminIndex/default', '', '门户管理', ''),
(139, 1, 'iqsa', 'admin_url', 'iqsa/AdminPage/index', '', '页面管理', ''),
(140, 1, 'iqsa', 'admin_url', 'iqsa/AdminPage/add', '', '添加页面', ''),
(141, 1, 'iqsa', 'admin_url', 'iqsa/AdminPage/addPost', '', '添加页面提交', ''),
(142, 1, 'iqsa', 'admin_url', 'iqsa/AdminPage/edit', '', '编辑页面', ''),
(143, 1, 'iqsa', 'admin_url', 'iqsa/AdminPage/editPost', '', '编辑页面提交', ''),
(144, 1, 'iqsa', 'admin_url', 'iqsa/AdminPage/delete', '', '删除页面', ''),
(145, 1, 'iqsa', 'admin_url', 'iqsa/AdminTag/index', '', '文章标签', ''),
(146, 1, 'iqsa', 'admin_url', 'iqsa/AdminTag/add', '', '添加文章标签', ''),
(147, 1, 'iqsa', 'admin_url', 'iqsa/AdminTag/addPost', '', '添加文章标签提交', ''),
(148, 1, 'iqsa', 'admin_url', 'iqsa/AdminTag/upStatus', '', '更新标签状态', ''),
(149, 1, 'iqsa', 'admin_url', 'iqsa/AdminTag/delete', '', '删除文章标签', ''),
...
(30, 2, 0, '文章显示之前', 'portal_before_assign_article', 'iqsa', '文章显示之前'),
(31, 2, 0, '后台文章保存之后', 'portal_admin_after_save_article', 'iqsa', '后台文章保存之后'),
...
(45, 2, 1, '门户后台文章管理列表界面', 'portal_admin_article_index_view', 'iqsa', '门户后台文章管理列表界面'),
(46, 2, 1, '门户后台文章分类管理列表界面', 'portal_admin_category_index_view', 'iqsa', '门户后台文章分类管理列表界面'),
(47, 2, 1, '门户后台页面管理列表界面', 'portal_admin_page_index_view', 'iqsa', '门户后台页面管理列表界面'),
(48, 2, 1, '门户后台文章标签管理列表界面', 'portal_admin_tag_index_view', 'iqsa', '门户后台文章标签管理列表界面'),
...
(56, 4, 0, '门户后台文章添加编辑界面右侧栏', 'portal_admin_article_edit_view_right_sidebar', 'iqsa', '门户后台文章添加编辑界面右侧栏'),
(57, 4, 0, '门户后台文章添加编辑界面主要内容', 'portal_admin_article_edit_view_main', 'iqsa', '门户后台文章添加编辑界面主要内容'),
(58, 2, 1, '门户后台文章添加界面', 'portal_admin_article_add_view', 'iqsa', '门户后台文章添加界面'),
(59, 2, 1, '门户后台文章编辑界面', 'portal_admin_article_edit_view', 'iqsa', '门户后台文章编辑界面'),
(60, 2, 1, '门户后台文章分类添加界面', 'portal_admin_category_add_view', 'iqsa', '门户后台文章分类添加界面'),
(61, 2, 1, '门户后台文章分类编辑界面', 'portal_admin_category_edit_view', 'iqsa', '门户后台文章分类编辑界面'),
(62, 2, 1, '门户后台页面添加界面', 'portal_admin_page_add_view', 'iqsa', '门户后台页面添加界面'),
(63, 2, 1, '门户后台页面编辑界面', 'portal_admin_page_edit_view', 'iqsa', '门户后台页面编辑界面'),
...
CREATE TABLE IF NOT EXISTS `cmf_theme_file` (
  ...
  `file` varchar(50) NOT NULL DEFAULT '' COMMENT '模板文件，相对于模板根目录，如Portal/index_cn.html',

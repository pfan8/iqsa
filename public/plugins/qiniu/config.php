...
return [
    'accessKey'                 => [// 在后台插件配置表单中的键名 ,会是config[text]
        ...
        'tip'     => '<a href="https://iqsa.qiniu.com/signup?code=3lfihpz361o42" target="_blank">马上获取</a>,充值使用ThinkCMF七牛专属优惠码<a href="http://www.thinkcmf.com/qiniu/promotion_code.html" target="_blank">507670e8</a>有更多优惠,<a href="http://www.thinkcmf.com/faq.html?url=https://www.kancloud.cn/thinkcmf/faq/507454" target="_blank">查看帮助手册</a>' //表单的帮助提示
    ],
    'secretKey'                 => [// 在后台插件配置表单中的键名 ,会是config[password]
        ...
        'tip'     => '<a href="https://iqsa.qiniu.com/signup?code=3lfihpz361o42" target="_blank">马上获取</a>, <a href="http://www.thinkcmf.com/faq.html?url=https://www.kancloud.cn/thinkcmf/faq/507454" target="_blank">查看帮助手册</a>'
    ],
